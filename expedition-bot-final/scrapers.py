...
The scrapers.py file includes Python code for scraping hotel and flight information from Booking.com and Kayak websites, respectively. 
- It imports a range of libraries such as Selenium, BeautifulSoup, pandas, Spacy, and others. 
- The scrape_hotels function extracts city and date information from a text input, 
    constructs a URL, and scrapes hotel data like names, locations, prices, and ratings using Selenium and BeautifulSoup, 
    organizing the data into a sorted Pandas DataFrame.
- The scrape_flights function processes text input to gather travel details, constructs a URL for Kayak, 
    and scrapes flight information including times, prices, and airlines, also formatting the results into a DataFrame. 

Both functions use headless ChromeDriver for web scraping and include error handling for input validation.
